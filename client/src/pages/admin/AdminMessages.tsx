  ...
  return (
    <AdminShell title="Inbox">
            ...
            {items.map((m) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span
                    className={`inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-xs ${m.read ? "bg-[--bg-tertiary] text-[--text-muted]" : "bg-[--accent-cyan]/10 text-cyan"}`}
                  >
                    <span
                      className={`h-1.5 w-1.5 rounded-full ${m.read ? "bg-[--text-muted]" : "bg-[--accent-cyan]"}`}
                    />
                    {m.read ? "Read" : "Unread"}
                  </span>
                </td>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-xl rounded-lg border border-[--border-soft] bg-[--bg-secondary] p-6"
          ...
          >
            ...
            <p className="mt-5 text-sm text-[--text-secondary] leading-relaxed whitespace-pre-wrap">
              {open.message}
            </p>
            <div className="mt-6 flex justify-end gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md border border-[--border-soft] px-4 py-2 text-sm"
              >
