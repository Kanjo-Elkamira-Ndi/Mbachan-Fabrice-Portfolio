      ...
      <ResourceCrud<Project>
        ...
        columns={[
          ...
          { key: "category", label: "Category" },
          {
            key: "confidential",
            label: "Confidential",
            render: (r) => (r.confidential ? "Yes" : "No"),
          },
        ]}
        renderForm={(s, set) => (
          <>
            ...
            <Field label="Challenge">
              <textarea
                ...
                className={inputCls}
                value={s.challenge}
                onChange={(e) => set({ ...s, challenge: e.target.value })}
              />
            </Field>
            <Field label="Outcome">
              <textarea
                ...
                className={inputCls}
                value={s.outcome}
                onChange={(e) => set({ ...s, outcome: e.target.value })}
              />
            </Field>
            <Field label="Metrics (comma separated)">
              <input
                className={inputCls}
                value={s.metrics.join(", ")}
                onChange={(e) =>
                  set({
                    ...s,
            ...
            <label className="flex items-center gap-2 text-sm">
              <input
                ...
                onChange={(e) => set({ ...s, confidential: e.target.checked })}
              />
