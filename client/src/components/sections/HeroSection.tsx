    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 pt-24">
        <div className="w-full md:w-[55%]">
          ...
          >
            I help organizations defend their infrastructure through offensive security, secure
            engineering, and intelligent threat response. Based in Cameroon, operating globally.
          </motion.p>
